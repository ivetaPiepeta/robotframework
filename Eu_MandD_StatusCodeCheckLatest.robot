...
*** Test Cases ***
Open Browser And Check Statuses of hrefs on whole page desktop and mobile
    Open Browser And Check Statuses of hrefs on whole page  ${DESKTOP_WIDTH}    ${DESKTOP_HEIGHT}
    Open Browser And Check Statuses of hrefs on whole page  ${MOBILE_WIDTH}    ${MOBILE_HEIGHT}
